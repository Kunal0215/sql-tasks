...
<?php
      include "nav.php";
      echo "<br>WAQ to list all employee_domain with sum of it's salary.<br><br> ";
...
echo "<tr><th>Domain</th><th>Salary</th></tr>";
    ...
    $tbl5 = "SELECT employee_code_table.employee_domain, sum(employee_salary_table.employee_salary) AS sum 
